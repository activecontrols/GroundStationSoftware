    ...
    */
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
                ...
                return  new msg_traj_req_k1(this);
                        case msg_traj_k1.MAVLINK_MSG_ID_TRAJ_K1:
                return  new msg_traj_k1(this);
                        case msg_traj_req_k2.MAVLINK_MSG_ID_TRAJ_REQ_K2:
                return  new msg_traj_req_k2(this);
                        case msg_traj_k2.MAVLINK_MSG_ID_TRAJ_K2:
                return  new msg_traj_k2(this);
                        case msg_traj_req_pt.MAVLINK_MSG_ID_TRAJ_REQ_PT:
                return  new msg_traj_req_pt(this);
                        case msg_traj_pt.MAVLINK_MSG_ID_TRAJ_PT:
